...
async function renderTime() {
    ...
    const url = `https://script.google.com/macros/s/AKfycbz0Q_y1hwA9ir7_d6GznAuKfgriD8WFVN1DodfHxsvelup7TquMxYgtdIslDK18l89qfw/exec?date=${encodeURIComponent(selectedDate)}`;
